...
namespace VwdCms
{
    ...
    public class SplitterBar : Panel, INamingContainer, IPostBackDataHandler
    {
        ...
        private string _leftResizeTargets = string.Empty;
        // semi-colon delimited
        private string _rightResizeTargets = string.Empty;
        // semi-colon delimited
        private string _topResizeTargets = string.Empty;
        // semi-colon delimited
        private string _bottomResizeTargets = string.Empty;
        // semi-colon delimited
        ...
        private string _saveWidthToElement = null;
        ...
        private Control[] GetTargetControls(string controlIds)
        {
            ...
            if (ids != null && ids.Length > 0)
            {
                ...
                Control c = null;
                string id = null;
                controls = new Control[ids.Length - 1 + 1];
        ...
        private void RegisterPageStartupScript()
        {
            ...
            const string newline = Constants.vbCr + Constants.vbLf;
            ...
            if (this.NamingContainer != null && this.NamingContainer != this.Page)
            {
                string prefix = this.NamingContainer.ClientID + this.ClientIDSeparator.ToString();
            ...
            this.Page.ClientScript.RegisterStartupScript(this.GetType(), this.ClientID + "_VwdCmsSplitterBarStartupScript", sb.ToString());
        }

        // IPostBackDataHandler Members

        private bool IPostBackDataHandler_LoadPostData(string postDataKey, NameValueCollection postCollection)
        {
            return this.LoadPostData(postDataKey, postCollection);
        }

        private void IPostBackDataHandler_RaisePostDataChangedEvent()
        {
        }
    }
}
