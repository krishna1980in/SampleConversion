...
namespace Kartris
{
    ...
    {
        private const string WRAPPER_CSS_CLASS = "Kartris-RadioButtonList";
        private const string ITEM_CSS_CLASS = "Kartris-RadioButtonList-Item";
        ...
        protected new override void RenderContents(HtmlTextWriter writer)
        {
            ...
            if (buttonList != null)
            {
                foreach (ListItem li in buttonList.Items)
                {
                    ...
                    // </li>
                    if (this.Page != null)
                        System.Web.UI.Adapters.ControlAdapter.Page.ClientScript.RegisterForEventValidation(buttonList.UniqueID, li.Value);
                }

                if (this.Page != null)
                    System.Web.UI.Adapters.ControlAdapter.Page.ClientScript.RegisterForEventValidation(buttonList.UniqueID);
            }
        }
