...
partial class Admin_KnowledgeBase : _PageBaseClass
{
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            {
                litFeatureDisabled.Text = Replace(GetGlobalResourceObject("_Kartris", "ContentText_DisabledInFrontEnd"), "[name]", GetGlobalResourceObject("_Knowledgebase", "PageTitle_KnowledgeBase"));
