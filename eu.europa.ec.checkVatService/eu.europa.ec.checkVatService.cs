...
namespace kartris
{
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="urn:ec.europa.eu:taxud:vies:services:checkVat", ConfigurationName="kartris.checkVatPortType")]
    public interface checkVatPortType
    {
        ...
        System.Threading.Tasks.Task<kartris.checkVatResponse> checkVatAsync(kartris.checkVatRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<kartris.checkVatApproxResponse> checkVatApproxAsync(kartris.checkVatApproxRequest request);
    }
    ...
    public partial class checkVatApproxResponse
    {
        ...
        public checkVatApproxResponse(
                    ...
                    string traderCity, 
                    kartris.matchCode traderNameMatch, 
                    kartris.matchCode traderCompanyTypeMatch, 
                    kartris.matchCode traderStreetMatch, 
                    kartris.matchCode traderPostcodeMatch, 
                    kartris.matchCode traderCityMatch, 
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public interface checkVatPortTypeChannel : kartris.checkVatPortType, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public partial class checkVatPortTypeClient : System.ServiceModel.ClientBase<kartris.checkVatPortType>, kartris.checkVatPortType
    {
        ...
        public System.Threading.Tasks.Task<kartris.checkVatResponse> checkVatAsync(kartris.checkVatRequest request)
        {
            return base.Channel.checkVatAsync(request);
        }
        
        public System.Threading.Tasks.Task<kartris.checkVatApproxResponse> checkVatApproxAsync(kartris.checkVatApproxRequest request)
        {
